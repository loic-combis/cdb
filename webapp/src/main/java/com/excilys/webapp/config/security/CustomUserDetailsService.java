...
import static com.excilys.core.User.ROLE_USER;
...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        Optional<com.excilys.core.User> optUser = userDAO.findByLogin(username);
    ...
    private User buildUserForAuthentication(com.excilys.core.User user, List<GrantedAuthority> authorities) {
